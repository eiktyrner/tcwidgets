...
$(document).ready(function(){//When the page is loaded, do the following.
	...
	configDisable.on("click", function(){
		...
		var aspect = aspects[configInput.val().toLowerCase()];
...
function validate(event){
	...
	validity[this.id] = aspects[asp] ? true : false;//If an aspect exists with the name inputted into this field, mark this field valid.
